...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Majeedbot/Files_moo/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Majeedbot/moo/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس زلزال \n") 
end
return false
end
...
end --الكود حصري سورس زلزال يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'زلزال').." غادر" or text == 'بوت غادر' then  
